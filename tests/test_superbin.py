...
superbin_cases = {
    "TC1_one_bad_bin_center": {
        "bin_contents": np.array([[20, 20, 20], [20, 1, 20], [20, 20, 20]]),
        "merged_contents": [
            [(0, 0)],
            [(0, 1)],
            [(0, 2)],
    ...
    "TC2_no_bad_bin_center": {
        "bin_contents": np.array([[20, 20, 20], [20, 20, 20], [20, 20, 20]]),
        "merged_contents": [
            [(0, 0)],
            [(0, 1)],
            [(0, 2)],
    ...
    "TC3_all_bad_bins": {
        "bin_contents": np.array([[1, 1, 1], [1, 1, 1], [1, 1, 1]]),
        "merged_contents": [
            [(0, 0)],
            [(0, 1)],
            [(0, 2)],
    ...
    "TC4_random_bad_bins": {
        "bin_contents": np.array([[20, 1, 20], [0.5, 1, 3], [2, 50, 1]]),
        "merged_contents": [
            [(0, 0)],
            [(0, 1)],
            [(0, 2)],
...
badbin_cases = {
    ...
    "TC4_random_bad_bins": {
        "bin_contents": np.array([[20, 1, 20], [0.5, 1, 3], [2, 50, 1]]),
        "merged_contents": [[(1, 0)], [(1, 1)], [(0, 1)], [(2, 2)], [(2, 0)], [(1, 2)]],
    },
}
